...
INSERT INTO `products` (`id`, `product_name`, `serial_number`, `category`, `purchase_date`, `warranty_period`, `warranty_end_date`, `client_id`, `image_path`, `status`, `notes`, `created_at`, `updated_at`) VALUES ('5', 'MOUSE', 'TEST', 'Accessory', '2026-01-13', '6', '2026-07-13', '3', 'uploads/1768300185_boy-alone-swing-3840x2160-24352.png', 'active', '', '2026-01-13 18:29:45', '2026-01-13 18:29:45');
